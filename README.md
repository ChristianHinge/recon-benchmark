...
Expects `/data/input/add.hs`, `/data/input/mult.hs`, `/data/input/prompts.hs`; writes results to `/data/output`. All env vars are optional (defaults: `ZOOM=0.5`, `ITERATIONS=4`, `SUBSETS=5`, `THREADS` and `VERBOSE` unset).
